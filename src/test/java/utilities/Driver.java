...
public class Driver {
    ...
    // neden private ? ==> sadece bu class içerinde kullanilabilsin i baska classlardan call edilmesin
    // neden ?

    static final String TELEFONADI = "PIXEL2"; // bu degere bu scopta bile olsa tekrardan bi atama yapamazsıniz demektir.
